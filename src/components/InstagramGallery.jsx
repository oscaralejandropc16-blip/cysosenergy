...
export const InstagramGallery = () => {
  ...
  // Load and inject the live Tagembed script smoothly
  useEffect(() => {
    ...
    // Interval to aggressively clean up any third-party ads or share buttons
    const cleanupInterval = setInterval(() => {
      const shareBtns = document.querySelectorAll(
        '.tagembed-share-btn, [class*="share-experience"], [class*="share_experience"], [class*="powered"], [class*="branding"], button:has([class*="share"])'
      );
  ...
  // Keyboard ESC key listener to close video modal
  useEffect(() => {
  ...
  return (
    <section id="galeria" className="py-24 relative bg-navy-950 border-t border-slate-800 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[850px] h-[850px] bg-gold-metallic/10 rounded-full blur-[190px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* High-End Official Profile Card */}
        ...
        {/* CLEAN EMBEDDED REAL-TIME INSTAGRAM FEED WITHOUT SHARE BUTTONS */}
        <div className="clean-instagram-wrapper luxury-glass p-2 sm:p-4 rounded-3xl border border-gold-metallic/30 shadow-2xl relative">
          <div 
